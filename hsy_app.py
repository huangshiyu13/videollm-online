...
from hsy_inference import LiveInfer
    ...
    with gr.Row():
        ...
        with gr.Column():
            gr_chat_interface = gr.ChatInterface(
                ...
                examples=['Please narrate the video in real time.', 'Please describe what I am doing.',
                          'Could you summarize what have been done?', 'Hi, guide me the next step.'],
            )
            ...
            gr_frame_token_interval_threshold = gr.Slider(minimum=0, maximum=1, step=0.05,
                                                          value=liveinfer.frame_token_interval_threshold,
                                                          interactive=True, label="Streaming Threshold")
            gr_frame_token_interval_threshold.change(gr_frame_token_interval_threshold_change,
        ...
        gr_liveinfer_queue_refresher.change(gr_liveinfer_queue_refresher_change, inputs=[gr_chat_interface.chatbot],
