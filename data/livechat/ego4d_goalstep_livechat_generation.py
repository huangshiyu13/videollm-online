...
class Ego4DLiveChatGeneration(Ego4D):
    ...
    def __init__(self, num_queries_each_conversation: int, num_conversations_each_video: int, **kwargs):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained('/workspace/intern_ckpt/Mirror/modelscope/models/llm-research/meta-llama-3-8b-instruct', use_fast=True)
        self.model = AutoModelForCausalLM.from_pretrained('/workspace/intern_ckpt/Mirror/modelscope/models/llm-research/meta-llama-3-8b-instruct', torch_dtype='auto', attn_implementation='sdpa')
        self.model.to('cuda')
        self.model.eval()
